> **Record.** This evidence record came with the evidence-gated proposal (PR #2, 2026-09-03). It supports `docs/klon-handoff.md` (revision 3) and `docs/proposals/2026-09-03-evidence-gated-workspaces.md`. The requirement identifiers R2, R4, R5, R13, and R14 below refer to the proposal.
